...
const Dropdown = props => {    
    ...
    return (
        <div className="col-sm-6 form-group row px-0">     
            ...
            <select value={props.selectedValue} onChange={dropdownChanged} className="form-control form-control-sm col-sm-10" style={{backgroundColor:'#2B2E33', border:'none',color:'#edeeef'}}>
